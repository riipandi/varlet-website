...
You can also use a `meta.json` file to config the order and displayed name of the page ([example](https://github.com/riipandi/varlet/blob/main/pages/meta.json)).
