...
[![](https://vercel.com/button)](https://vercel.com/new/clone?demo-description=Markdown%20powered%20docs%20site.%20Built%20with%20Next.js.&demo-image=https%3A%2F%2Fvarlet.vercel.app%2Fdemo.png&demo-title=Documentation%20Starter%20Kit&demo-url=https%3A%2F%2Fvarlet.vercel.app%2F&project-name=nextjs-docs&repository-name=nextjs-docs&s=https%3A%2F%2Fgithub.com%2Fshuding%2Fnextra&from=templates)
...
// theme.config.js
export default {
  projectLink: 'https://github.com/riipandi/varlet', // GitHub link in the navbar
  docsRepositoryBase: 'https://github.com/riipandi/varlet/blob/main', // base URL for the docs repository
  titleSuffix: ' – Nextra',
  nextLinks: true,
  prevLinks: true,
  search: true,
...
<Callout>
  ...
  and title. <br /> Check the source code: https://github.com/riipandi/varlet for
  more information.
</Callout>
