  ...
  >
    ...
    <label class="relative block">
      ...
      <div class="absolute inset-y-0 left-0 flex items-center justify-center px-4 py-2 opacity-50">
        <icon
          icon="search"
          class="text-xl text-on-background"
        />
      </div>
      <input
        ref="input"
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <span
              v-if="result.value === result.title"
            ...
            <span
              v-else
              class="flex items-center transition-none"
            >
              {{ result.title }}
              <icon
                icon="chevronRight"
                class="mx-2 text-2xl transition-none"
              />
